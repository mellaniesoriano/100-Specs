...
Scientist.prototype.checkDiscipline = function(check) {
  var checkIndex = this.disciplines.indexOf(check);
  if ( checkIndex !== -1 ) {
    return true;
  } else {
    return false;
...
var closeAnOpenBox = new Box('puppies', true).openBox();
 ...
 *
 */
var farTooTallAStory = new House(78).isATallStory(3);
...
var cookieMonsterBlocked = new Cookie('peanut butter').swipedByCookieMonster('Saturday');
